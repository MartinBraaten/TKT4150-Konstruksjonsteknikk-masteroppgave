...
start = 33
slutt = 65
Y2 = data.iloc[start: slutt,5].values  # values converts it into a numpy array
X2 = data.iloc[start: slutt,6].values  # Density
X3 = data.iloc[start: slutt,7].values  # MC
X4 = data.iloc[start: slutt,8].values  # Annual
